    ...
    public static Dictionary<ConditionID, Condition> Conditions { get; set; } = new Dictionary<ConditionID, Condition>()
    {
        { ConditionID.PSN,
            new Condition()
            {
                ...
                {
                    pokemon.UpdateHP(pokemon.MaxHp / 8); //Reduces pokemon health by 1/8 of Pokemon HP after every turn
        ...
        { ConditionID.BRN,
            new Condition()
            {
                ...
                OnAfterTurn = (Pokemon pokemon) => //Lambda function
                {
                    pokemon.UpdateHP(pokemon.MaxHp / 16); //Reduces pokemon health by 1/16 of Pokemon HP after every turn
